...
describe("Check Box tests", () => {
    ...
    it("renders as expected", () => {
        ...
        const divs = [
            ...wrapper.findAll(".vnm-checked-div"),
            ...wrapper.findAll(".vnm-unchecked-div")
        ]
    ...
    it("renders tick when checked", () => {
        ...
        expect(wrapper.find(".vnm-unchecked-div").isVisible()).toBe(false);
    });
    ...
    it("renders no icon when unchecked", () => {
        ...
        expect(icons[0].isVisible()).toBe(false);
        expect(icons[1].isVisible()).toBe(false);
        expect(wrapper.find(".vnm-unchecked-div").isVisible()).toBe(true);
    });
});
